...
export const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Logs the login dynamic structure matching {"phoneNumber": "...", "accountPin": "..."}
    console.log("Submitting Auth Credentials Payload:", credentials);

    const result = await login(credentials);
    console.log("Auth System Result:", result);
